...
function TextOnlyCard({ project }: { project: Project }) {
    ...
    return (
        <div
            ...
            className={`group relative flex flex-col justify-between overflow-hidden rounded-2xl border border-neutral-200 bg-white p-6 transition-colors hover:border-accent-400/50 dark:border-neutral-800 dark:bg-neutral-900 ${project.size}`}
        >
            <div
            ...
            <div className="relative">
                <div className="flex flex-wrap gap-2">
                    {project.badge && (
                        <span className="rounded-full border border-accent-400/40 px-3 py-1 font-mono text-xs text-accent-500">
                            ✦ {project.badge}
                        </span>
                    )}
                    {project.stack.map((tech) => (
                        <span
                            key={tech}
                            className="rounded-full border border-neutral-200 px-3 py-1 font-mono text-xs text-neutral-600 dark:border-neutral-700 dark:text-neutral-400"
                        >
                            {tech}
                        </span>
                    ))}
